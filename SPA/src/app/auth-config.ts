...
export const msalConfig: Configuration = {
    auth: {
        clientId: '6c37393b-094f-46b0-9a74-e4acb88940be', // This is the ONLY mandatory field that you need to supply.
        authority: 'https://login.microsoftonline.com/6479ea96-6331-4242-a64a-564bf46e1e6d', // Defaults to "https://login.microsoftonline.com/common"
